<template>
  <section class="policy">
    ...
    <div class="policy__information" v-html="information"></div>
  </section>
</template>
          ...
          <li class="policy__item">
            ...
            <ol class="policy__sublist">
              ...
              <li class="policy__subitem">
                ...
                уведомление на адрес электронной почты Оператора raklechitsa@bfkh.ru
          ...
          <li class="policy__item">
            ...
            <ol class="policy__sublist">
              <li class="policy__subitem">
                ...
                к Оператору с помощью электронной почты raklechitsa@bfkh.ru.
              </li>
              <li class="policy__subitem">
